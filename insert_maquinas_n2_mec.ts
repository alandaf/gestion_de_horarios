...
async function run() {
    ...
    const cursoNombre = "Formación Máquinas Nivel 2- II- ING MEC - 2026-1";

    const scheduleData = [
        // LUNES
        { dia: 'LUNES', inicio: '14:15', fin: '15:00', asig: 'Legislation Marittima Nacional', prof: 'Rodolfo Estay', sala: '106' },
        ...
        { dia: 'MARTES', inicio: '15:00', fin: '15:45', asig: 'Equipo Sistemas Aux', prof: 'German Kreisel', sala: '103' },
        { dia: 'MARTES', inicio: '16:00', fin: '16:45', asig: 'Equip Sistemas Aux', prof: 'German Kreisel', sala: '103' },
        { dia: 'MARTES', inicio: '16:45', fin: '17:30', asig: 'Equipo Sistemas Aux', prof: 'German Kreisel', sala: '103' },
        ...
        // MIERCOLES
        { dia: 'MIÉRCOLES', inicio: '14:15', fin: '15:00', asig: 'Electrónica', prof: 'R. Toro', sala: '103' },
        { dia: 'MIÉRCOLES', inicio: '15:00', fin: '15:45', asig: 'Electrónica', prof: 'R. Toro', sala: '103' },
        ...
        // JUEVES
        { dia: 'JUEVES', inicio: '14:15', fin: '15:00', asig: 'Ingles Operation Máquinas', prof: 'K. Escudero', sala: '103' },
        { dia: 'JUEVES', inicio: '15:00', fin: '15:45', asig: 'Inglés Operación Máquinas', prof: 'K. Escudero', sala: '103' },
        { dia: 'JUEVES', inicio: '16:00', fin: '16:45', asig: 'Inglés Operación Máquinas', prof: 'K. Escudero', sala: '103' },
        { dia: 'JUEVES', inicio: '16:45', fin: '17:30', asig: 'Inglés Operación Máquinas', prof: 'K. Escudero', sala: '103' },
        { dia: 'JUEVES', inicio: '17:45', fin: '18:30', asig: 'Deberes de Guardia', prof: 'Jaime Vizcarra', sala: '105' },
        { dia: 'JUEVES', inicio: '18:30', fin: '19:15', asig: 'Deberes de Guardia', prof: 'Jaime Vizcarra', sala: '105' },

        // VIERNES
        { dia: 'VIERNES', inicio: '14:15', fin: '15:00', asig: 'Electrónica', prof: 'R. Toro', sala: '103' },
        { dia: 'VIERNES', inicio: '15:00', fin: '15:45', asig: 'Electrónica', prof: 'R. Toro', sala: '103' },
