...
async function run() {
    ...
    const cursoNombre = "Formación Máquinas Nivel 2- I Semestre- ING Electr. - 2026-1";
    ...
    const scheduleData = [
        ...
        { dia: 'JUEVES', inicio: '16:00', fin: '16:45', asig: 'Ingles Operation Máquinas', prof: 'K. Escudero', sala: '103' },
